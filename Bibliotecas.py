...
raio = float(input("Insira qual o raio da circunferencia para saber o valor que vai pagar: "))
area = pi * pow(raio,2)
valor = area * 25.00

print(f"Você precisará pagar R$ {round(valor,2)} por uma área de {round(area,2)} metros de grama")    # round(numero fracional, quantidade de casas
# depois da virgula), round fromata um numero de forma que voce escolhe quantas casas quer veer depois da virgula.